...
protected
	...
	def configure_permitted_parameters
		...
		devise_parameter_sanitizer.permit(:sign_up) { |u| u.permit(:nom, :avatar, :moto, :foto_moto, :localitat, :data_naixement, :presentacio, :mobil, :email, :password, :stripe_card_token)}
